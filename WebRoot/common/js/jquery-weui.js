...
//如果参数过多，建议通过 config 对象进行配置，而不是传入多个参数。
  $.prompt1 = function(text, title, onOK, onCancel, input) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p><input type="number" class="weui-input weui-prompt-input" id="weui-prompt-input" value="' + (config.input || '') + '" />',
      title: config.title,
      autoClose: false,
      buttons: [
      {
...
$.login = function(text, title, onOK, onCancel, username, password) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p>' +
            '我方得分：<input type="number" style="width:110px;" maxlength="5" class="weui-input weui-prompt-input" id="weui-prompt-username" value="' + (config.username || '') + '" placeholder="输入我方得分" /><br />' +
            '对方得分：<input type="number" style="width:110px;" maxlength="5" class="weui-input weui-prompt-input" id="weui-prompt-password" value="' + (config.password || '') + '" placeholder="输入对方得分" />',
      title: config.title,
      autoClose: false,
      buttons: [
      {
