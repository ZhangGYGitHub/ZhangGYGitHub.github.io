...
<body>
	<div class="weui-tab"  id="text">
		<div class="weui-tab__bd">
			<form action="${pageContext.request.contextPath}/feedback/leagueFeedBackSave?matchId=${lmid}" method="post" id="myForm">
				<input type="hidden" name="id" value="<s:property value='id'/>">
				<input type="hidden" name="lmid" value="<s:property value='lmid'/>">
					...
					<div class="weui-cells weui-cells_form" id="div-form">
						...
						<div class="weui-cell">
							<div class="weui-cell__bd">
								<textarea class="weui-textarea" name="leagueComment.content" id="content" 
